defmodule FleetLM.Archive do
  ...
  @messages_tab :fleet_lm_archive_messages
  @conversations_tab :fleet_lm_archive_conversations
  ...
  defp flush_all(%{adapter: adapter} = state) do
    ...
    FleetLM.Observability.Telemetry.archive_queue_age(age_seconds)

    FleetLM.Observability.Telemetry.archive_flush(
      elapsed,
      attempted_total,
      inserted_total,
      pending_rows,
