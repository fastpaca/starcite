defmodule FleetLM.Session do
  @moduledoc """
  Core session entity for FleetLM.

  A session is an append-only sequence of events with deterministic ordering.
  FleetLM stores event streams and replay semantics; it does not impose an
  ...
  def new(id, opts \\ []) when is_binary(id) do
    ...
    tail_keep = opts[:tail_keep] || Application.get_env(:fleet_lm, :tail_keep, 1_000)
